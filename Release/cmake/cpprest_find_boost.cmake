...
function(cpprest_find_boost)
  ...
  elseif(UNIX)
    find_package(Boost CONFIG REQUIRED COMPONENTS random system thread filesystem chrono atomic date_time regex)
  else()
    find_package(Boost CONFIG REQUIRED COMPONENTS system date_time regex)
  endif()
